    ...
    <footer className="bg-gray-800 text-white py-7">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm font-poppins font-thin text-gray-300 ">
              ...
              untuk menyajikan hidangan lezat dan berkualitas tinggi untuk
              berbagai acara, mulai dari pernikahan hingga acara perusahaan.
              Dengan pengalaman bertahun-tahun, kami menggunakan bahan-bahan
              segar dan resep yang teruji untuk memastikan setiap hidangan
              memuaskan. Tim profesional kami siap membantu Anda merencanakan
              setiap detail acara, menawarkan pilihan menu yang beragam,
              sehingga semua tamu dapat menikmati pengalaman kuliner yang tak
              terlupakan.
            </p>
          </div>
          <div>
            ...
            <div className="flex mb-2 items-center">
              ...
              <p className="text-sm font-poppins font-thin text-gray-300 ml-2">
                Jalan Parangtritis Km. 13, Bakulan, Patalan, Jetis, Bantul
              </p>
            </div>
            <div className="flex mb-2 items-center">
              <FaMailchimp size={24} />{" "}
        ...
        <div className="mt-8 border-t border-gray-700 pt-4 text-center">
          <p className="text-sm">© 2024 Kayla Catering. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
